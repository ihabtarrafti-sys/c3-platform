...
const useStyles = makeStyles({
  ...
  sectionTitle: { fontSize: '12px', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--c3-ink-quiet)', fontFamily: 'var(--c3-font-mono)', marginBottom: '12px' },
  mintRow: { display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', gap: '12px', marginBottom: '18px' },
  tokenBox: {
    marginBottom: '18px',
    padding: '12px 14px',
    border: '1px solid var(--c3-action-primary)',
  ...
  tokenNote: { fontSize: '12.5px', color: 'var(--c3-ink-muted)' },
  tokenUrl: { fontFamily: 'var(--c3-font-mono)', fontSize: '12px', color: 'var(--c3-ink-default)', wordBreak: 'break-all' },
  meta: { fontSize: '12.5px', color: 'var(--c3-ink-muted)' },
  metaMono: { fontFamily: 'var(--c3-font-mono)', fontSize: '11.5px', color: 'var(--c3-ink-quiet)' },
  ...
  kvKey: { color: 'var(--c3-ink-quiet)' },
  kvVal: { color: 'var(--c3-ink-default)' },
