...
const useStyles = makeStyles({
  ...
  recWrap: { fontSize: '13.5px', color: 'var(--c3-ink)', display: 'flex', flexDirection: 'column', rowGap: '2px' },
  recTitle: { display: 'flex', alignItems: 'baseline', columnGap: '8px' },
  recId: { fontFamily: 'var(--c3-font-mono)', fontSize: '11.5px', color: 'var(--c3-ink-muted)' },
  recSub: { fontSize: '12px', color: 'var(--c3-ink-muted)' },
  meta: { fontSize: '12.5px', color: 'var(--c3-ink-mid)' },
  metaWho: { fontFamily: 'var(--c3-font-mono)', fontSize: '11.5px', color: 'var(--c3-ink-muted)' },
  recordLink: { fontSize: '12.5px', color: 'var(--c3-brand)' },
  muted: { fontSize: '12px', color: 'var(--c3-ink-muted)' },
