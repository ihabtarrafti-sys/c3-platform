...
const useStyles = makeStyles({
  ...
  card: {
    position: 'relative',
    backgroundColor: 'var(--c3-paper-white, #fff)',
    border: '1px solid var(--c3-hairline, rgba(15,15,16,0.12))',
    borderRadius: '6px',
    padding: '16px 20px 14px 24px',
    overflow: 'hidden',
  },
  rail: { position: 'absolute', left: 0, top: 0, bottom: 0, width: '4px' },
  railImmediate: { backgroundColor: 'var(--c3-signal-red, #e5484d)' },
  railAttention: { backgroundColor: '#d99a1b' },
  railWatch: { backgroundColor: 'var(--c3-ink-40, rgba(15,15,16,0.4))' },
  railInMotion: { backgroundColor: 'var(--c3-hairline, rgba(15,15,16,0.16))' },
  topRow: { display: 'flex', alignItems: 'baseline', columnGap: '10px', flexWrap: 'wrap' },
  eyebrow: {
    fontSize: '11px',
    letterSpacing: '0.08em',
    textTransform: 'uppercase',
    color: 'var(--c3-ink-60, rgba(15,15,16,0.6))',
    fontWeight: 600,
  },
  scoreChip: {
    marginLeft: 'auto',
  ...
  inMotionChip: {
    ...
    textTransform: 'uppercase',
    color: 'var(--c3-ink-60, rgba(15,15,16,0.6))',
    border: '1px dashed var(--c3-hairline, rgba(15,15,16,0.25))',
    borderRadius: '999px',
    padding: '2px 10px',
    whiteSpace: 'nowrap',
  },
  headline: { fontSize: '16px', lineHeight: '24px', fontWeight: 600, color: 'var(--c3-command-black, #0f0f10)', margin: '6px 0 8px' },
  reasons: { margin: '0 0 12px', paddingLeft: '18px', display: 'flex', flexDirection: 'column', rowGap: '3px' },
  reason: { fontSize: '13px', lineHeight: '20px', color: 'var(--c3-ink-70, rgba(15,15,16,0.7))' },
  ...
  check: { fontSize: '13px', lineHeight: '20px', color: 'var(--c3-ink-60, rgba(15,15,16,0.6))' },
  checkedNote: { fontSize: '12px', color: 'var(--c3-ink-60, rgba(15,15,16,0.6))', marginTop: '16px' },
});
