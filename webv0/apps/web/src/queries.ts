...
// Track B: departure workflow.
export const useDepartures = (enabled = true) => useQuery({ queryKey: ['departures'], queryFn: () => api.listDepartures(), enabled });
...
export const useComments = (subjectType: string, subjectId: string, enabled = true) =>
  useQuery({ queryKey: ['comments', subjectType, subjectId], queryFn: () => api.listComments(subjectType, subjectId), enabled });
...
export const useMissionDistributions = (missionId: string, enabled = true) =>
  useQuery({ queryKey: ['missionDistributions', missionId], queryFn: () => api.missionDistributions(missionId), enabled });
...
export const useMission = (missionId: string, enabled = true) =>
  useQuery({ queryKey: ['mission', missionId], queryFn: () => api.getMission(missionId), enabled });
