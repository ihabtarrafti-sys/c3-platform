...
export const DOCUMENT_OWNER_TYPES = ['Agreement', 'Mission', 'Person', 'Credential', 'Entity'] as const;
...
const ownerIdField = z
  .string()
  .regex(/^(AGR|MSN|PER|CRED|ENT)-\d{4,}$/, 'ownerId must be a canonical business id');
